	...
	return (
		<nav className="bg-primary py-2 sticky top-0 z-[30]">
			...
			<div className="w-[50%] border border-grayDark h-12 rounded-lg flex">
				<button className="w-[25%]">All Category <i className="pi pi-chevron-down"></i></button>
				<input type="text" id="" className="w-[55%]" placeholder="Search products..." />
				<button className="bg-black text-secondary rounded-lg h-12 w-[20%]">Search</button>
			</div>
